...
all: objdir $(OBJS)
	nvcc ch7__1d_convolution.cu -o 1d_convolution.out $(COMPILEDOBJS) $(CFLAGS) $(INCLUDES)
	nvcc ch7__2d_convolution.cu -o 2d_convolution.out $(COMPILEDOBJS) $(CFLAGS) $(INCLUDES)
